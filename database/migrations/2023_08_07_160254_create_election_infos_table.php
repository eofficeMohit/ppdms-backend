...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('election_infos', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_party_reached')->default(0)->nullable();
            $table->tinyInteger('is_poll_started')->default(0)->nullable();
            $table->tinyInteger('is_poll_ended')->default(0)->nullable();
            $table->float('voting')->nullable();
            $table->tinyInteger('is_nopolling')->default(0)->nullable();
            ...
            $table->tinyInteger('is_party_dispatch')->default(0)->nullable();
            $table->dateTime('dispatch_last_updated')->nullable();
            $table->tinyInteger('is_mockpoll_done')->default(0)->nullable();
            $table->dateTime('mockpoll_last_updated')->nullable();
            $table->integer('voter_in_queue')->default(0)->nullable();
            $table->dateTime('voter_in_queue_last_updated')->nullable();
            $table->tinyInteger('polling_party_left')->default(0)->nullable();
            $table->dateTime('polling_party_left_last_updated')->nullable();
            $table->tinyInteger('evm_deposited')->default(0)->nullable();
            $table->dateTime('evm_deposited_last_updated')->nullable();
            $table->tinyInteger('is_booth_capt')->default(0)->nullable();
            $table->dateTime('booth_capt_last_updated')->nullable();
            $table->tinyInteger('is_law_prob')->default(0)->nullable();
            $table->dateTime('law_prob_last_updated')->nullable();
            $table->tinyInteger('is_evm_prob')->default(0)->nullable();
            $table->dateTime('evm_prob_last_updated')->nullable();
            $table->tinyInteger('is_mockpoll_clear')->default(0)->nullable();
            $table->dateTime('mockpollclear_last_updated')->nullable();
            $table->tinyInteger('is_battery_removed')->default(0)->nullable();
