...
<script type="text/javascript">
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        if (permission_delete == "granted") {
                            btn +=
                                '<a rel="tooltip" onclick="openConfirmModal('+full.id+')" class="btn btn-danger btn-link m-2" data-original-title="Delete Event" title="Delete Event"><i class="material-icons">delete</i><div class="ripple-container"></div></a>';
                        }
                        return btn;
                    }
                },
    ...
    function openConfirmModal(id){
        var btn_html = '<a href="/event/destroy/'+id+'" class="btn  btn-outline-danger">Yes</a><a type="button" class="btn  btn-danger waves-effect" onclick="closeConfirmModal()">No</a>';
