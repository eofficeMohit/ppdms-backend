...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'dashboard' ? ' active bg-gradient-dark ' : '' }} " href="{{ route('dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'dashboard-stat' ? ' active bg-gradient-dark ' : '' }} " href="{{ route('dashboard.stat') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                ...
                <div class="collapse {{ $activePage == 'booth' ? 'show' : '' }} {{ $activePage == 'manage-assembly' ? 'show' : '' }} {{ $activePage == 'events' ? 'show' : '' }} {{ $activePage == 'states' ? 'show' : '' }} {{ $activePage == 'districts' ? 'show' : '' }} {{ $activePage == 'parliaments' ? 'show' : '' }} {{ $activePage == 'sector-officer' ? 'show' : '' }} " id="pagesExamples" style="">
                    <ul class="nav ms-4">
                        @can('assembly-list')
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $activePage == 'manage-assembly' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('assemblies') }}">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        @can('booth-list')
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $activePage == 'booth' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('booth') }}">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        @endcan
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $activePage == 'sector-officer' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('so.index') }}">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        @can('parliament-list')
                        <li class="nav-item">
                            <a class="nav-link text-white {{ $activePage == 'parliaments' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('parliaments.index') }}">
                                <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @can('state-list')
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'states' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('states.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @can('district-list')
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'districts' ? ' active bg-gradient-dark ' : '' }}  " href="{{ route('districts.index') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            @can('event-list')
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'events' ? ' active bg-gradient-dark' : '' }}  " href="{{ route('events') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">format_textdirection_r_to_l</i>
                    </div>
    ...
    <li class="nav-item">
        ...
        <div class="collapse {{ $activePage == 'roles' ? 'show' : '' }} {{ $activePage == 'permissions' ? 'show' : '' }} {{ $activePage == 'users' ? 'show' : '' }}" id="pagesExamples1" style="">
            <ul class="nav ms-4">
                @can('user-list')
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'users' ? ' active bg-gradient-dark ' : '' }} " href="{{ route('users.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @can('role-list')
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'roles' ? ' active bg-gradient-dark ' : '' }}" href="{{ route('roles.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                @can('permission-list')
                <li class="nav-item">
                    <a class="nav-link text-white {{ $activePage == 'permissions' ? ' active bg-gradient-dark ' : '' }}" href="{{ route('permissions.index') }}">
                        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'user-profile' ? 'active bg-gradient-dark ' : '' }} " href="{{ route('user-profile') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                <i class="material-icons opacity-10">person</i>
            </div>
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'notifications' ? 'active bg-gradient-dark ' : '' }} " href="{{ route('notifications') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'login-report' ? 'active bg-gradient-dark ' : '' }} " href="{{ route('login.report') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'issue-management' ? 'active bg-gradient-dark ' : '' }} " href="{{ route('issue.index') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'map_booth' ? ' active bg-gradient-dark' : '' }}" href="{{ route('map_booth') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <li class="nav-item">
        <a class="nav-link text-white {{ $activePage == 'election-info' ? ' active bg-gradient-dark' : '' }}" href="{{ route('election-info') }}">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
