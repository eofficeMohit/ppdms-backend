                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            if(permission_delete == "granted"){
                                btn += '<a rel="tooltip" onclick="return confirm('+confirmation+')" class="btn btn-danger btn-link m-2" href="election-info/destroy/'+full.id+'" data-original-title="Delete E-Info" title="Delete E-Info"><i class="material-icons">delete</i><div class="ripple-container"></div></a>';
                            }
                            return btn;
                        }
                    },
