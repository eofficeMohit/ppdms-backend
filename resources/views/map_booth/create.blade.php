                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sel_assembly" name="sel_assembly">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="so_officer" name="so_officer">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div id="box_div1" class="box form-group" ondrop="dragDrop(event, this)" ondragover="allowDrop(event)">
                                        ...
                                        <ul class="div1 form-control" id="box1">
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div id="box_div2" class="box form-group" ondrop="dragDrop(event, this)" ondragover="allowDrop(event)">
                                        ...
                                        <ul class="div1 form-control" id="box2">
                                        </ul>
                                    </div>
                                </div>  
                            </div>
