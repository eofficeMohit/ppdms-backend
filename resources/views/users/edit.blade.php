                ...
                <div class="col-md-12 mt-4">
                    <div class="card">
                        ...
                        <div class="card-body pt-4 p-3">
                            ...
                            @endif
                            {!! Form::model($user, ['method' => 'PATCH', 'route' => ['users.update', $user->id], 'id' => 'edit_user_form']) !!}
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="1" {{ 1 == $user->status ? 'selected' : '' }}>Active
                                            </option>
                                            <option value="0" {{ 0 == $user->status ? 'selected' : '' }}>In-Active
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
