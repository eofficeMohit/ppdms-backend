                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('asmb_code', null, ['placeholder' => 'ASMB Code', 'class' => 'form-control']) !!}
                                        @error('asmb_code')
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('ac_type', null, ['placeholder' => 'AC Type', 'class' => 'form-control']) !!}
                                        @error('ac_type')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="state_id" name="state_id">
                                            @foreach ($states as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key == $assembly->state_id ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('state_id')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="district_id" name="district_id">
                                            ...
                                            @foreach ($districts as $key => $value)
                                                <option value="{{ $key }}"
                                                    {{ $key == $assembly->district_id ? 'selected' : '' }}>
                                                    {{ $value }}</option>
                                            @endforeach
                                        </select>
                                        @error('district_id')
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('asmb_name', null, ['placeholder' => 'ASMB Code', 'class' => 'form-control']) !!}
                                        @error('asmb_name')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::text('ac_name_uni', null, ['placeholder' => 'ASMB Code', 'class' => 'form-control']) !!}
                                        @error('ac_name_uni')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-xs-6 col-sm-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status">
                                            <option value="1" {{ 1 == $assembly->status ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="0" {{ 0 == $assembly->status ? 'selected' : '' }}>
                                                In-Active</option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-danger">{{ $message }}</div>
